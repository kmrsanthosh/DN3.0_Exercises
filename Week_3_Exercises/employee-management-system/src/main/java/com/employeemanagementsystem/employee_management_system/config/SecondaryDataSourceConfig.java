...
@Configuration
@EnableJpaRepositories(basePackages = "com.employeemanagementsystem.employee_management_system.secondary.repository", entityManagerFactoryRef = "secondaryEntityManagerFactory", transactionManagerRef = "secondaryTransactionManager")
